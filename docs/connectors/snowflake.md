...
![Snowflake system](../assets/Snowflake_system.png)
...
| **Authentication Type**    | Select the Authentication type to connect with Snowflake instance. Supported authentication types: <br> 1. Basic Authentication <br> 2. Key Pair Authentication [link](https://docs.snowflake.com/en/user-guide/key-pair-auth) <br> 3. OAuth 2.0 [link](https://docs.snowflake.com/en/user-guide/oauth-ext-overview) <br> 4. Native SSO (using Okta only) [link](https://docs.snowflake.com/en/user-guide/admin-security-fed-auth-configure-idp) |
...
![Note](../assets/Note.jpg) All the names of table or field mentioned here will be treated as case-sensitive and should match the actual names in Snowflake instance.
...
![Snowflake mapping](../assets/Snowflake_mapping.png)

![Note](../assets/Note.jpg) Field having foreign key constraint will be shown as Reference type of field. It should contain valid ID value of the table it refers to.  
![Note](../assets/Note.jpg) Workflow Transition is not applicable for Snowflake connector.
...
![Snowflake integration](../assets/Snowflake_integration.png)
...
![Note](../assets/Note.jpg) The name of the field mentioned in criteria query should be same as the actual name of the field in table. **If field name contains lower case characters, wrap the field name within "", such as "order_value" > 5000**
...
![Note](../assets/Note.jpg) The name of the field mentioned in target lookup query should be same as actual name of the field in table. **If field name contains lower case characters, wrap the field name within ", such as "order_id" = '@source_entity_id@'**
...
3. Click **+ User** button to create a new user.  
   ![Snowflake add user](../assets/Snowflake_add_user.png)
4. Enter the user details. The value provided in Login Name will be used later for login using that user. Default Role can also be set. If the **Force user to change password on first login** checkbox is selected, the user must change their password on first login.  
   ![Snowflake add user form](../assets/Snowflake_add_user_form.png)
5. Save changes.
...
2. Click **+ Role** button to create a new role.  
   ![Snowflake add role](../assets/Snowflake_add_role.png)
3. Enter the **New Role** details.  
   ![Snowflake add role form](../assets/Snowflake_add_role_form.png)
4. Save changes.
