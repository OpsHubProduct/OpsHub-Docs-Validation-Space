...
| **Test Management Plugin**            | Always                                                                                                   | Choose a Jira plugin to sync test entities. {{SITENAME}} currently supports the test management plugins Zephyr, Zephyr Essential and Xray.<br>If Zephyr (Scale) is selected for Jira Cloud, refer to the [Zephyr](jirazephyrscale.md) connector documentation..                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
