...
<div align="center"><img src="../assets/Bugzilla_Image_9a.png" alt=""></div>
...
> > &#xNAN;_&#x45;xample: If product field has value 'R\&D' then the query will be `product=R@OH_AND@D&priority=High`._

> > **Note** : Bugzilla uses fields' internal name for query.\
> > &#xNAN;_&#x46;or example in `status=RESOLVED&priority=High` query, status is the internal name of field 'Status'. Refer_ [_Custom Field Internal Name_](bugzilla.md#custom-field-internal-name) _section to know the internal name of Bugzilla Custom Fields._
...
* When BugZilla is the **source** system:
  ...
  * For Bugzilla version **less than 5.0**: 'History' based synchronization and [Sync\_Only\_Current\_State](../integrate/integration-configuration.md#sync_only_current_state) option are supported.
  ...
  * For the 'Large Text Boxes' type of field, if the field content contains more than 255 characters, the user might see extra space in the content after approximately 255 characters post synchronization.\
    &#xNAN;_&#x52;eason: Bugzilla History API gives details with such extra space._
...
<div align="center"><img src="../assets/Bugzilla_Image_1a.png" alt=""></div>

\*\*Bugzilla User Privilege Step 1\*\*

<div align="center"><img src="../assets/Bugzilla_Image_2.jpg" alt=""></div>

\*\*Bugzilla User Privilege Step 2\*\*

<div align="center"><img src="../assets/Bugzilla_Image_3.jpg" alt=""></div>
...
<div align="center"><img src="../assets/Bugzilla_Administration_Parameters.png" alt=""></div>

* Click on **User Authentication** on the left pane as shown in the screenshot below:

<div align="center"><img src="../assets/Bugzilla_User_Authentication.png" alt=""></div>

* Scroll down to **requirelogin** option and select **off** as shown in the screenshot below:

<div align="center"><img src="../assets/Bugzilla_requirelogin.png" alt=""></div>
...
<div align="center"><img src="../assets/Bugzilla_Image_4.jpg" alt=""></div>

<div align="center"><img src="../assets/Bugzilla_Image_5.jpg" alt=""></div>
...
<div align="center"><img src="../assets/Bugzilla_Image_6a.png" alt=""></div>
...
<div align="center"><img src="../assets/Bugzilla_Image_7.jpg" alt=""></div>
...
<div align="center"><img src="../assets/Bugzilla_Image_8a.png" alt=""></div>
