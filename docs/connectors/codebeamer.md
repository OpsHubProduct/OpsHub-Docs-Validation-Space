...
| **Version**                       | Always                                      | Provide the version for the codebeamer/codebeamerX system. Refer to section [Find version of codebeamer/codebeamerX Instance](#find-version-of-codebeamer-codebeamer-x-instance), to determine the version of codebeamer/codebeamerX system. |
