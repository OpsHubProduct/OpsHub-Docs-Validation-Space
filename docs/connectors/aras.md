{{DISPLAYTITLE:Aras Innovator}}

## Prerequisites<br>

### User Privileges<br>

* Create a user in Aras Innovator that is dedicated for OpsHub Integration Manager. The user shouldn't perform any other action from Aras Innovator user interface. Refer to [[#Add users | Add User in Aras Innovator]] section to learn how to add a new user in Aras Innovator.
* The user identity of the user dedicated for OpsHub Integration Manager must have the following permissions for the 'item type' to be integrated:<br>
...
### Hosting Opshub Aras Service<br>
...
Before the user continues with the integration, he/she must first configure Aras Innovator System. Refer to [[System Configuration]] to learn step-by-step process to configure a system. See the screenshot given below for reference:
...
Check [[Mapping Configuration]] to learn the step-by-step process to configure mapping between the systems.
...
* To show the 'Display Id' as Remote Id, it is required to add the Item Number field in Aras.  
  Refer to [[#Set Item Number for Custom Entity|Add Item Number Field]] for more details.
...
<p align="center">
  <img src="../assets/Aras_Select_identity_5.png" width="1250px" />
</p>
...
<p align="center">
  <img src="../assets/Aras_LifeCycle_State_Transition_2.png" width="950px" />
</p>
