...
* Create a user in Aras Innovator that is dedicated for OpsHub Integration Manager. The user shouldn't perform any other action from Aras Innovator user interface. Refer to [Add User in Aras Innovator](#add-users) section to learn how to add a new user in Aras Innovator.
