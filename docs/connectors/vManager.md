...
![VMGR\_mapping.png](../assets/VMGR_mapping.png)
...
![VMGR\_parameters.png](../assets/VMGR_parameters.png)
...
![VMGR\_subtype\_list.png](../assets/VMGR_subtype_list.png)
...
![VMGR\_integration\_page.png](../assets/VMGR_integration_page.png)
...
**Example Queries**\
&#xNAN;_&#x43;riteria Query on the **single field**:_\
...
_Criteria Query on the **Multi-Enum**:_\
...
_Criteria Query on **multiple fields**:_\
...
* Target Lookup Query for the constraint on the multiple fields: {"@@c" : ".ChainedFilter", "condition" : "AND", "chain" : \[{"@@c":".AttValueFilter","operand":"EQUALS","attName":"element\_id","attValue":"@id@"},{"@@c":".AttValueFilter","operand":"EQUALS","attName":"name","attValue":"@title@"}]}
...
_When Verisium Manager is the source system in the integration:_
...
_When Verisium Manager is the target system in the integration:_
...
* Select "System Configurations" -> "Security" -> "System Users" -> "New"\
  ![VMGR\_create\_user\_navigation](../assets/VMGR_create_user_navigation.png)
* In "Create a new user" window, please provide "UserName" and click "Create" button\
  ![VMGR\_create\_user\_window](../assets/VMGR_create_user_window.png)
...
* Created user will be available in the list of "Users" under "System Users". To determine the access levels of the created Verisium Manager User for the specific Verisium Manager Porject, please refer to [Add User in Project with Permissions](vManager.md#add-user-in-project-with-permissions)\
  ![VMGR\_user\_list](../assets/VMGR_user_list.png)
...
* Setting : "Enable authorization and access control (All authentication channels must be enabled)" shall be disabled.\
  ![vmgr\_project\_security\_configuration](../assets/vmgr_project_security_configuration.png)
...
* Select "Configurations" -> "System Level" -> "Security".\
  ![vmgr\_project\_identifier\_1](../assets/vmgr_project_identifier_1.png)
* Select "System Groups" tab under "System Security Configurations".
* Select "New" in "Groups".\
  ![vmgr\_create\_group](../assets/vmgr_create_group.png)
...
* Select "Add" in "Users of group ".\
  ![vmgr\_add\_user\_in\_group](../assets/vmgr_add_user_in_group.png)
...
* Select "Add" in "Groups with access to project ". Select the newly created and click "Add Selected".\
  ![vmgr\_add\_group\_project](../assets/vmgr_add_group_project.png)
...
* Setting: "Block vAPI/Web from serving non-administration requests" must be disabled\
  ![vmgr\_project](../assets/vmgr_project.png)
...
* Click on the **User Attributes** -> **Import user defined attributes from csv file**\
  ![VMGR\_add\_uda](../assets/VMGR_add_uda.png)
* It will open **ImportAttributes** window. Please select the file that is saved in step 1 ([Create csv file for Custom Field](vManager.md#create-csv-file-for-custom-field)) and click **Open** button. For example, if file is saved with the name `custom_attributes.csv`, then select that file in this window and click Open button\
  ![VMGR\_add\_uda\_import](../assets/VMGR_add_uda_import.png)
* Now the added Custom field can be seen in the **User Defined Attributes** section\
  ![VMGR\_add\_uda\_2](../assets/VMGR_add_uda_2.png)
...
* Select "Projects" pane under the "System Settings".\
  ![vmgr\_project\_identifier\_2](../assets/vmgr_project_identifier_2.png)
