...
| 3 | Azure DevOps Server | {{:TFS_SupportedVersions}} | {{:TFS_SupportedEnities}} | Team Foundation Server (TFS) |
| 4 | Azure DevOps Server Version Control | {{:TFS_SupportedVersions}} | {{:TFVC_SupportedEntities}} | Team Foundation Server Version Control |
| 5 | Azure DevOps Services | All | {{:VSTS_SupportedEntities}} | Visual Studio Team Services (VSTS) |
