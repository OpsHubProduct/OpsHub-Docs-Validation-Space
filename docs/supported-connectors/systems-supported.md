...
| 3 | Azure DevOps Server | {% include "../.gitbook/includes/tfs-supported-versions.md" %} | {% include "../.gitbook/includes/tfs-supported-entities.md" %} | Team Foundation Server (TFS) |
| 4 | Azure DevOps Server Version Control | {% include "../.gitbook/includes/tfs-supported-versions.md" %} | {% include "../.gitbook/includes/tfvc-supported-entities.md" %} | Team Foundation Server Version Control |
