...
![Server to Server](../assets/Server_to_server_inline.png)
...
![Entity to Entity](../assets/Entity_to_entity_inline.png)
...
![Server to Entity](../assets/Server_to_entity_inline.png)
