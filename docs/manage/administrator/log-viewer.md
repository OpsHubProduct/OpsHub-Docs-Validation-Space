...
| OpsHub.log             | <p><code class="expression">space.vars.SITENAME</code> Application log file for all the {% if "OpsHub Migrator for Microsoft Azure DevOps" === space.vars.SITENAME"%} migrations{% endif %} {% if "OpsHub Integration Manager" === space.vars.SITENAME" %}integrations {% endif %}                                                                                      |
