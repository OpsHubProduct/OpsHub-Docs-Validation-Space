...
* Following are the types of **Purge** provided:
  ...
  * **Integrated Data Records**: It enables users to purge integrated data records from the OpsHub Integration Manager database. Refer to the [Purge Integrated Data Records](#purge-integrated-data-records) section for more details.

## Steps to access the Purge Feature
* Navigate to the top-right corner of the screen and click **Administration**.  
![purge_administration_list_2.png](../assets/purge_administration_list_2.png)

* Now, click the **Purge** icon on the left sidebar, as shown in the image.  
![Purge_entry_page_1_2.png](../assets/Purge_entry_page_1_2.png)
...
![Purge_audits_2_1.png](../assets/Purge_audits_2_1.png)
...
![Purge_audits_2_2.png](../assets/Purge_audits_2_2.png)
...
<span style="color:blue">**Required role**</span><br>
...
<span style="color:blue">**Minimum required permissions in case of customized roles**</span><br>
...
* For **deleted integrations**:
  ...
  * If they are still in use, the purge will fail with an error, as illustrated in the image below.  
    ![Purge error](../assets/Purge_error.png)
