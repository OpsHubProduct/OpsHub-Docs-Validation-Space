[OH-TFS/AzureDevOps-0019: `<Entity_type>` with ID `<Entity_Id>` does not exist in the server or integration user does not have permission to access entity.](../tfs/oh-tfs-0019.md)
