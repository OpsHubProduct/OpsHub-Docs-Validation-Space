...
In the advanced installation, if **OpsHub Integration Manager** is installed with the option of the [manual creation of the database](/docs/getting-started/installation.md#manual-creation-of-the-databases), then:
