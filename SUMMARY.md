  ...
  *  **Help Center**
      * FAQs
          ...
          * [Installer](docs/help-center/faqs/installer-faqs.md)
            ...
            * [Can the {% if "OpsHub Migrator for Microsoft Azure DevOps" === space.vars.SITENAME %} <code class="expression">space.vars.SITENAME</code> {% endif %} {% if "OpsHub Integration Manager" === space.vars.SITENAME %} OpsHub Server{% endif %} Service be run by Active Directory users? If yes, what are the permissions required to run it?](docs/help-center/faqs/installer/oim-service-run-by-active-directory-users.md)  
