  ...
  *  **Help Center**
      * FAQs
          * [General](docs/help-center/faqs/general-faqs.md)
            ...
            * [Are there any vulnerabilities in {{SITENAME}} ?](docs/help-center/faqs/general/vulnerabilities.md)  
            ...
            * [How to move {{SITENAME}} from CentOS to Ubuntu?](docs/help-center/faqs/general/move-application-server.md)  
          ...
          * [Clarity](docs/help-center/faqs/clarity-faqs.md)
            * [Which authentication modes do {{SITENAME}} support for Clarity?](docs/help-center/faqs/clarity/clarity-auth-types.md)  
          ...
          * [Installer](docs/help-center/faqs/installer-faqs.md)
            ...
            * [Can the {{#ifeq: {{SITENAME}} | OpsHub Migrator for Microsoft Azure DevOps |{{SITENAME}}|OpsHub Server}} Service be run by Active Directory users? If yes, what are the permissions required to run it?](docs/help-center/faqs/installer/oim-service-run-by-active-directory-users.md)  
